...
public final class Money {
    ...
    public Money discount(BigDecimal percentage) {
        ...
        BigDecimal discountAmount = this.amount.multiply(percentage).divide(new BigDecimal("100"), currency.getDefaultFractionDigits(), RoundingMode.HALF_UP);
        return subtract(new Money(discountAmount, currency));
    }
